...
const userProfileSchema = new Schema(
    {
        affirmation: {
            type: String,
            default:
                "Hey there! I'm your affirmation text! Double tap me and enter something as a reminder why you won't quit!"
        },
        ...
        nutritionSchedule: [Schema.Types.Mixed], //Likely DEPRECATED:
