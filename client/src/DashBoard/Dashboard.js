...
import {
    COLLAPSE_TRIGGER_WIDTH,
    FULL_LAYOUT_WIDTH,
    DOUBLE_TAP_HACK_HANDLER
...
class Dashboard extends Component {
    ...
    componentDidUpdate(prevProps, prevState) {
        if (
            this.props.userNutritionPlans !== prevProps.userNutritionPlans &&
            this.props.userNutritionPlans[0]
        ) {
            this.setState(
                {
        ...
        this.state.userLogs.forEach(log => {
            if (
                ...
                this.state.userMeals
                    .find(data => data.meal._id === log.id)
                    .meal.items.map(item => {
        ...
        return (
            <CardColumns className="card-wall mt-4">
                ...
                <Card>
                    ...
                    <CardBody>{/* <NutritionTable /> */}</CardBody>
                </Card>
              ...
              Active Training Plan: { this.props.activePlan.name }
                            ...
                            <>
                                <CardText>
                                    No plans active? Select a training plan!
                                </CardText>
                ...
                <Card>
                    ...
                    {!this.props.profile.nutritionCalories ? (
                        <p className="p-4 text-muted">
                            This is where your daily calories will be tracked.
                            Set a nutrition plan to get started.
                        </p>
                    ) : null}
                    <BarChart
                        display={
                            this.props.windowWidth < COLLAPSE_TRIGGER_WIDTH
                                ? false
                                : true
                        }
    ...
    getNextWorkout = () => {
        let eMap = []
        let day = Object.keys(this.props.activePlan.days[0]).find(
        ...
        return (
            <ListGroup>
                ...
                <ListGroupItemText>
                    {this.props.activePlan.days[0][day].title +
                        ': ' +
