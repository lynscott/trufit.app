...
import { Button, Modal, ModalHeader, ModalBody, ModalFooter, Badge, Input, InputGroup, InputGroupAddon,
...
const InfoText = ['Train smarter with custom plans that factor in your body fat, BMR, and activity level instantly.']
      ...
      <div className='row justify-content-center p-3' id="test-div">
          ...
          >
            <div className="col-md-8 align-middle">
              <Fade bottom>
                ...
                <p>
                  In a nutshell we're the Netflix of online fitness. Get it?
                  Okay we'll expand a bit more.
                </p>
              </Fade>
              {/* <Fade left>
                <img
          ...
          >
            <IconBlock
              ...
              title={'A Collection Of Workout Plans For Any Style of Training.'}
            />
            <IconBlock
              text={
                `We built a system from the ground up to help you manage your macros, create nutrition plans,
            ...
            <IconBlock
              text={
                `Our AI analyzes your physical and dietary activity to recommend actions based on your goal.
                  In a surplus? We'll bump up your activity to get you back on track.`
              }
              title={'AI That Works For You Just Like A Real Trainer.'}
      ...
      <div className="container-fluid bg-dark">
        <div className="row title-head" id="header">
          <div className="col d-md-block">
            <Fade top>
            <img src={require("./images/FT1-01-T.png")} className='img-fluid' style={{minWidth:10,marginBottom:0}} />
